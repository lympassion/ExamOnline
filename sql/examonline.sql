...
) ENGINE = InnoDB AUTO_INCREMENT = 30000001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `class`  (
  ...
  `student_cnt` int(0) NOT NULL,
  PRIMARY KEY (`class_id`) USING BTREE,
  INDEX `teacherid`(`teacher_id`) USING BTREE,
  INDEX `examid`(`exam_id`) USING BTREE,
  CONSTRAINT `examid` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES (1, 'java', 20000000, 8, 'java基础', 1);
INSERT INTO `class` VALUES (15, 'python', 20000001, 11, 'python基础', 3);
INSERT INTO `class` VALUES (16, 'python', 20000004, 6, 'python进阶', 0);
...
INSERT INTO `exam` VALUES (5, 'python-mid', 'python', 101, 105, '2021-07-12 07:07:00', '2021-07-24 07:07:00', 7200);
INSERT INTO `exam` VALUES (6, 'python-mid', 'python', 101, 105, '2021-07-12 07:07:00', '2021-07-24 07:07:00', 7200);
INSERT INTO `exam` VALUES (7, 'python-last', 'python', 100, 60, '2021-07-12 22:07:00', '2021-07-25 22:07:00', 7200);
INSERT INTO `exam` VALUES (8, '123', 'python', 100, 60, '2021-07-19 22:07:00', '2021-07-31 22:07:00', 3600);
INSERT INTO `exam` VALUES (9, '12345', 'python', 100, 60, '2021-07-17 19:07:00', '2021-07-30 19:07:00', 3600);
INSERT INTO `exam` VALUES (10, 'python期中考试', 'python', 100, 60, '2021-07-21 19:07:00', '2021-07-28 19:07:00', 3600);
INSERT INTO `exam` VALUES (11, 'python期中考试2', 'python', 101, 105, '2021-07-21 19:07:00', '2021-07-30 19:07:00', 3600);
...
CREATE TABLE `paper`  (
  ...
  INDEX `paper_id`(`paper_id`) USING BTREE,
  CONSTRAINT `paperid` FOREIGN KEY (`paper_id`) REFERENCES `real_paper` (`paper_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `paper` VALUES (16, 101, 'python', 0, 2, 0);
INSERT INTO `paper` VALUES (17, 101, 'python', 0, 70, 1);
INSERT INTO `paper` VALUES (18, 101, 'python', 0, 71, 2);
INSERT INTO `paper` VALUES (19, 101, 'python', 0, 72, 3);
INSERT INTO `paper` VALUES (20, 101, 'python', 0, 73, 4);
INSERT INTO `paper` VALUES (21, 101, 'python', 1, 78, 5);
INSERT INTO `paper` VALUES (22, 101, 'python', 1, 80, 6);
INSERT INTO `paper` VALUES (23, 101, 'python', 1, 88, 7);
INSERT INTO `paper` VALUES (24, 101, 'python', 1, 89, 8);
INSERT INTO `paper` VALUES (25, 101, 'python', 1, 90, 9);
INSERT INTO `paper` VALUES (26, 101, 'python', 2, 10, 10);
INSERT INTO `paper` VALUES (27, 101, 'python', 2, 11, 11);
INSERT INTO `paper` VALUES (28, 101, 'python', 2, 83, 12);
INSERT INTO `paper` VALUES (29, 101, 'python', 2, 85, 13);
INSERT INTO `paper` VALUES (30, 101, 'python', 2, 86, 14);
INSERT INTO `paper` VALUES (31, 101, 'python', 4, 93, 15);
INSERT INTO `paper` VALUES (32, 101, 'python', 4, 94, 16);
...
CREATE TABLE `question_set`  (
  `question_set_id` int(0) NOT NULL AUTO_INCREMENT,
  `student_id` int(0) NOT NULL,
  `question_id` int(0) NOT NULL,
  `set_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`question_set_id`) USING BTREE,
  INDEX `stu_id1`(`student_id`) USING BTREE,
  CONSTRAINT `ques_id1` FOREIGN KEY (`question_set_id`) REFERENCES `question` (`question_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `stu_id1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of question_set
-- ----------------------------
INSERT INTO `question_set` VALUES (2, 10000000, 2, '2021-07-18 21:08:43');
INSERT INTO `question_set` VALUES (3, 10000000, 70, '2021-07-18 21:21:39');
INSERT INTO `question_set` VALUES (4, 10000000, 71, '2021-07-18 21:21:42');
INSERT INTO `question_set` VALUES (5, 10000015, 73, '2021-07-21 08:44:15');
INSERT INTO `question_set` VALUES (6, 10000015, 78, '2021-07-21 08:44:17');
...
CREATE TABLE `real_paper`  (
  ...
  `paper_score_part1` int(0) NOT NULL DEFAULT 0,
  `paper_score_part2` int(0) NOT NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `real_paper` VALUES (100, 'python-test', 'python', 60, 0, 0);
INSERT INTO `real_paper` VALUES (101, 'python-mid', 'python', 105, 0, 0);
...
CREATE TABLE `student`  (
  ...
  `student_picture` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '/img/avatar2/0.png',
  PRIMARY KEY (`student_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000026 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (10000000, 'wang', NULL, '112@qq.com', '123456', 1, '/img/avatar2/22.png');
INSERT INTO `student` VALUES (10000015, 'loti', NULL, '123@qq.com', '123456', 1, '/img/avatar2/58.png');
INSERT INTO `student` VALUES (10000020, 'lolit', NULL, '123@qq.com', '123456', 0, '/img/avatar2/1.png');
INSERT INTO `student` VALUES (10000021, 'zhang', NULL, '123@qq.com', '123456', 0, '/img/avatar2/1.png');
INSERT INTO `student` VALUES (10000022, 'Yun', NULL, '123@qq.com', '123456', 0, '/img/avatar2/1.png');
INSERT INTO `student` VALUES (10000023, 'who', NULL, '123@qq.com', '123456', 0, '/img/avatar2/1.png');
INSERT INTO `student` VALUES (10000024, 'zjl', NULL, '123@qq.com', '123456', 0, '/img/avatar2/0.png');
INSERT INTO `student` VALUES (10000025, 'lolit', NULL, '123@qq.com', '123456', 0, '/img/avatar2/0.png');
...
CREATE TABLE `student_class`  (
  ...
  CONSTRAINT `classid` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `studentid` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student_class
-- ----------------------------
INSERT INTO `student_class` VALUES (1, 10000000, 1);
INSERT INTO `student_class` VALUES (15, 10000000, 15);
INSERT INTO `student_class` VALUES (16, 10000015, 15);
INSERT INTO `student_class` VALUES (17, 10000020, 15);
...
CREATE TABLE `student_exam`  (
  ...
  `student_score` int(0) NULL DEFAULT -1,
  `question_id` int(0) NOT NULL,
...
-- ----------------------------
INSERT INTO `student_exam` VALUES (71, 5, 10000000, 'C', 0, 2);
INSERT INTO `student_exam` VALUES (72, 5, 10000000, 'D', 0, 70);
INSERT INTO `student_exam` VALUES (73, 5, 10000000, 'B', 0, 71);
INSERT INTO `student_exam` VALUES (74, 5, 10000000, 'A', 0, 72);
INSERT INTO `student_exam` VALUES (75, 5, 10000000, 'B', 5, 73);
INSERT INTO `student_exam` VALUES (76, 5, 10000000, 'BD', 5, 78);
INSERT INTO `student_exam` VALUES (77, 5, 10000000, 'C', 3, 80);
INSERT INTO `student_exam` VALUES (78, 5, 10000000, 'A', 0, 88);
INSERT INTO `student_exam` VALUES (79, 5, 10000000, 'A', 3, 89);
INSERT INTO `student_exam` VALUES (80, 5, 10000000, 'A', 3, 90);
INSERT INTO `student_exam` VALUES (81, 5, 10000000, 'F', 0, 10);
INSERT INTO `student_exam` VALUES (82, 5, 10000000, 'T', 0, 11);
INSERT INTO `student_exam` VALUES (83, 5, 10000000, 'T', 0, 83);
INSERT INTO `student_exam` VALUES (84, 5, 10000000, 'F', 5, 85);
INSERT INTO `student_exam` VALUES (85, 5, 10000000, 'T', 5, 86);
INSERT INTO `student_exam` VALUES (86, 5, 10000000, 'msg %username% /time:100 you are hacked', 15, 93);
INSERT INTO `student_exam` VALUES (87, 5, 10000000, 'msg %username% /time:100 you are hacked', 10, 94);
INSERT INTO `student_exam` VALUES (122, 5, 10000015, 'A', 0, 2);
INSERT INTO `student_exam` VALUES (123, 5, 10000015, 'A', 5, 70);
INSERT INTO `student_exam` VALUES (124, 5, 10000015, 'A', 5, 71);
INSERT INTO `student_exam` VALUES (125, 5, 10000015, 'C', 5, 72);
INSERT INTO `student_exam` VALUES (126, 5, 10000015, 'D', 0, 73);
INSERT INTO `student_exam` VALUES (127, 5, 10000015, 'BC', 0, 78);
INSERT INTO `student_exam` VALUES (128, 5, 10000015, 'BD', 0, 80);
INSERT INTO `student_exam` VALUES (129, 5, 10000015, 'CD', 3, 88);
INSERT INTO `student_exam` VALUES (130, 5, 10000015, 'CD', 0, 89);
INSERT INTO `student_exam` VALUES (131, 5, 10000015, 'AB', 0, 90);
INSERT INTO `student_exam` VALUES (132, 5, 10000015, 'T', 5, 10);
INSERT INTO `student_exam` VALUES (133, 5, 10000015, 'F', 5, 11);
INSERT INTO `student_exam` VALUES (134, 5, 10000015, 'T', 0, 83);
INSERT INTO `student_exam` VALUES (135, 5, 10000015, 'T', 0, 85);
INSERT INTO `student_exam` VALUES (136, 5, 10000015, 'F', 0, 86);
INSERT INTO `student_exam` VALUES (137, 5, 10000015, 'contentType: \"application/json\",', 10, 93);
INSERT INTO `student_exam` VALUES (138, 5, 10000015, 'contentType: \"application/json\",', 5, 94);
INSERT INTO `student_exam` VALUES (139, 8, 10000000, 'C', 0, 2);
INSERT INTO `student_exam` VALUES (140, 8, 10000000, 'B', 0, 75);
INSERT INTO `student_exam` VALUES (141, 8, 10000000, 'CD', 0, 78);
INSERT INTO `student_exam` VALUES (142, 8, 10000000, 'B', 3, 79);
INSERT INTO `student_exam` VALUES (143, 8, 10000000, 'T', 5, 84);
INSERT INTO `student_exam` VALUES (144, 8, 10000000, 'F', 5, 85);
INSERT INTO `student_exam` VALUES (145, 8, 10000000, 'T', 5, 9);
INSERT INTO `student_exam` VALUES (146, 8, 10000000, 'cwccwwc', -1, 93);
INSERT INTO `student_exam` VALUES (147, 8, 10000000, 'cwwqcwqqwcw', -1, 94);
INSERT INTO `student_exam` VALUES (148, 11, 10000000, 'A', 0, 2);
INSERT INTO `student_exam` VALUES (149, 11, 10000000, 'B', 0, 70);
INSERT INTO `student_exam` VALUES (150, 11, 10000000, 'C', 0, 71);
INSERT INTO `student_exam` VALUES (151, 11, 10000000, 'B', 0, 72);
INSERT INTO `student_exam` VALUES (152, 11, 10000000, 'B', 5, 73);
INSERT INTO `student_exam` VALUES (153, 11, 10000000, 'BC', 0, 78);
INSERT INTO `student_exam` VALUES (154, 11, 10000000, 'C', 3, 80);
INSERT INTO `student_exam` VALUES (155, 11, 10000000, 'BCD', 5, 88);
INSERT INTO `student_exam` VALUES (156, 11, 10000000, 'AC', 0, 89);
INSERT INTO `student_exam` VALUES (157, 11, 10000000, 'AB', 0, 90);
INSERT INTO `student_exam` VALUES (158, 11, 10000000, 'F', 0, 10);
INSERT INTO `student_exam` VALUES (159, 11, 10000000, 'F', 5, 11);
INSERT INTO `student_exam` VALUES (160, 11, 10000000, 'T', 0, 83);
INSERT INTO `student_exam` VALUES (161, 11, 10000000, 'T', 0, 85);
INSERT INTO `student_exam` VALUES (162, 11, 10000000, 'T', 5, 86);
INSERT INTO `student_exam` VALUES (163, 11, 10000000, '这道题我不是很会', -1, 93);
INSERT INTO `student_exam` VALUES (164, 11, 10000000, '这道题我也不是很会', -1, 94);
...
CREATE TABLE `student_paper_record`  (
  ...
  `score_part1` int(0) NOT NULL DEFAULT 0,
  `score_part2` int(0) NOT NULL DEFAULT -1,
...
-- ----------------------------
INSERT INTO `student_paper_record` VALUES (4, 5, 10000000, 69, 44, 25);
INSERT INTO `student_paper_record` VALUES (5, 5, 10000015, 0, 28, 15);
INSERT INTO `student_paper_record` VALUES (6, 5, 10000020, -1, 0, -1);
INSERT INTO `student_paper_record` VALUES (7, 7, 10000000, 0, 0, -1);
INSERT INTO `student_paper_record` VALUES (8, 8, 10000000, 0, 18, -1);
INSERT INTO `student_paper_record` VALUES (9, 9, 10000000, 0, 0, -1);
INSERT INTO `student_paper_record` VALUES (10, 9, 10000015, 0, 0, -1);
INSERT INTO `student_paper_record` VALUES (11, 9, 10000020, -1, 0, -1);
INSERT INTO `student_paper_record` VALUES (12, 10, 10000000, 0, 0, -1);
INSERT INTO `student_paper_record` VALUES (13, 10, 10000015, 0, 0, -1);
INSERT INTO `student_paper_record` VALUES (14, 10, 10000020, -1, 0, -1);
INSERT INTO `student_paper_record` VALUES (15, 11, 10000000, 0, 23, -1);
INSERT INTO `student_paper_record` VALUES (16, 11, 10000015, -1, 0, -1);
INSERT INTO `student_paper_record` VALUES (17, 11, 10000020, -1, 0, -1);
...
CREATE TABLE `student_picture`  (
  `student_picture_id` int(0) NOT NULL AUTO_INCREMENT,
  `student_id` int(0) NOT NULL,
  `exam_id` int(0) NOT NULL,
  `picture_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `picture_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`student_picture_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student_picture
-- ----------------------------
...
CREATE TABLE `teacher`  (
  ...
  `teacher_course` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `teacher_picture` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '/img/avatar2/0.png',
  PRIMARY KEY (`teacher_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20000007 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20000000, 'ali', 1, '979@163.com', '123456', 'java', '/img/avatar2/1.png');
INSERT INTO `teacher` VALUES (20000001, 'bow', 0, '334@qq.com', '123456', 'python', '/img/avatar2/12.png');
INSERT INTO `teacher` VALUES (20000003, 'sl', 1, '324@qq.com', '123456', 'java', '/img/avatar2/1.png');
INSERT INTO `teacher` VALUES (20000004, '风昔', 0, 'Mori@gmail.com', '123456', 'python', '');
INSERT INTO `teacher` VALUES (20000007, 'prop', 1, 'Mori@gmail.com', '123456', NULL, '/img/avatar2/0.png');
