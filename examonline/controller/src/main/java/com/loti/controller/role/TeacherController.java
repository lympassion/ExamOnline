...
//        try {
            Teacher teacher = new Teacher(0,UserMap.get("realname"),
                    Integer.parseInt(UserMap.get("gender")),"Mori@gmail.com",
...
//        }
    ...
    @RequestMapping(value = "/getAllStuMyClass",method = RequestMethod.GET)
    @ResponseBody
    public List<Student> getStudentList(@RequestParam("tid") int teacher_id){
        return studentService.getStudentByTeacher(teacher_id);
    }
