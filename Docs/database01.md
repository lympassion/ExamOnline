...
| student_grade     | varchar | 20   | 年级     |                        |
| student_institute | varchar | 20   | 学院     |                        |
| student_major     | varchar | 50   | 专业     |                        |
| student_class     | varchar | 20   | 班级     |                        |
| student_email     | varchar | 30   | 学生邮箱 |                        |
| student_password  | varchar | 16   | 学生密码 | not null               |
| student_sex       | varchar | 2    | 性别     | 约束（男，女）NOT NULL |
| Spare             |         |      | 备用     |                        |
...
| teacher_sex       | varchar | 2    | 性别     | 约束（男，女）NOT NULL |
| teacher_age       | varchar | 3    | 年龄     | NOT NULL               |
| teacher_institute | varchar | 20   | 学院     | NOT NULL               |
| teacher_major     | varchar | 50   | 专业     | NOT NULL               |
| teacher_email     | varchar | 30   | 教师邮箱 | NOT NULL               |
| teacher_password  | varchar | 16   | 教师密码 | NOT NULL               |
| teacher_title     | varchar | 15   | 职称     | NOT NULL               |
| teacher_resume    | varchar | 255  | 简单履历 | NOT NULL               |
| Spare             |         |      | 备用     |                        |
...
| admin_sex      | varchar | 2    | 性别       | 约束（男，女）NOT NULL                                    |
| admin_age      | varchar | 3    | 年龄       | NOT NULL                                                  |
| admin_email    | varchar | 20   | 管理员邮箱 | NOT NULL                                                  |
| admin_password | varchar | 16   | 管理员密码 | NOT NULL                                                  |
| admin_level    | varchar | 1    | 级别       | 普通管理员不能添加新的管理员 系统管理员可以添加新的管理员 |
| Spare          |         |      | 备用       |                                                           |
...
| 字段        | 类型    | 位数 | 说明       | 备注 |
| ----------- | ------- | ---- | ---------- | ---- |
| cource_id   | varchar | 10   | 课程编号   | 主键 |
| cource_name | varchar | 20   | 课程科目名 |      |
| grade       | varchar | 20   | 年级       |      |
